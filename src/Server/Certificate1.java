...
public class Certificate1 {
    ...
    public Certificate1(Connection connect ,int id) {
    ...
    public void generate()
    {
        ...
        try {
           ...
           /* Paragraph para=new Paragraph("Covid Vaccination Certificate");
            ...
            int did= Integer.parseInt(r.getString("dose1_id"));
            query="SELECT * FROM Covax.dose1 WHERE dose_id="+did+";";
            ...
            if(em==null)
            {
                String message = "Dear "+name+" Congratulations You have successfully been vaccinated with your first dose of vaccine .You may dowload ypur certificate.";
                try {
