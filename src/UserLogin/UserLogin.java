    ...
    public void OTPSender(ActionEvent actionEvent) {
        if (PhoneNo.getText().equals("")&&Email.getText().equals("")) {
            ...
            try {
                ...
                alert.setTitle("Information Dialog");
                alert.setHeaderText("Alert");
                alert.setContentText("Number is wrong or there is some issue");
                alert.showAndWait();
            }
        }
        else if(PhoneNo.getText().equals(""))
        {
            ...
            try {
                ...
                alert.setTitle("Information Dialog");
                alert.setHeaderText("Alert");
                alert.setContentText("Email address is wrong or there is some issue");
                alert.showAndWait();
            }
